...
bins = 10;  % 决定M_1数据量，即拟合D_1曲线光滑度，如何调？ 
...
%%  基于重构生成时间序列数据
initial = 1;
series = mod.simulate(1:1:10000, initial, struct('MaxStep', 0.01));
re_tab = series.y;
t= series.t;

plot(t, re_tab) 
figure(2)
plot(t(1500:1:2000), re_tab(1500:1:2000)) 
%save('Mea_simuldata2','re_tab', 't', '-v7.3')
...
% % hold on
line([1, 200], [0.4667 0.4667], 'LineWidth', 2, 'LineStyle', '--', 'color', [55/256 131/256 59/256]);
line([201, 285], [-0.7784 -0.7784], 'LineWidth', 2, 'LineStyle', '--', 'color',  [0.6350, 0.0780, 0.1840]);
line([286, 396], [0.4667 0.4667],  'LineWidth', 2, 'LineStyle', '--', 'color', [55/256 131/256 59/256]);
...
ylabel(mod.namex,'fontsize',18,'fontname','Times')	%设置x轴字体
