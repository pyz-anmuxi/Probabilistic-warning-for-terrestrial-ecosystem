...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 赋予边界条件（ 'RA'，‘AR’），domain
            if isstruct(ibasin)
                ...
                if eqnr == 1
                    obj.equilibria(eqnr).domain(2) = obj.equilibria(2).x;
                else
                    obj.equilibria(eqnr).domain(1) = obj.equilibria(2).x;
                end
...
% pdepe求解survival概率
        function res = survival(obj, ibasin, varargin)
            ...
            if isempty(options.time_range)
                ...
                options.time_range = [0 find(meansurv<0.005,1)+1];
            end
